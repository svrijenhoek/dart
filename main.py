...
def main():
    ...
    # if dart.handler.mongo.connector.MongoConnector().exists('support', 'stories'):
    ...
    # if dart.handler.mongo.connector.MongoConnector().exists('users') and config["append"] == "N":
    #     dart.handler.mongo.connector.MongoConnector().drop('users')
    ...
    # if dart.handler.mongo.connector.MongoConnector().exists('recommendations') and config["append"] == "N":
    #     dart.handler.mongo.connector.MongoConnector().drop('recommendations')

...
def execute(configuration):
    n_users = configuration["number_of_users"]
    n_topics = configuration["average_topical_interest"]
    n_spread = configuration["average_spread_per_interest"]
    mean_popular = configuration["size_popular_stories"]
    mean_random = configuration["user", "size_random"]
